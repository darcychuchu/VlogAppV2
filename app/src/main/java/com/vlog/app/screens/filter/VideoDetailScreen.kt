...
import androidx.compose.material.icons.Icons // Required for Icons.AutoMirrored.Filled.ArrowBack
import androidx.compose.material.icons.automirrored.filled.ArrowBack // Specific import for ArrowBack
...
fun VideoDetailScreen(
    // navController: NavController, // If needed for back navigation or other actions
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(uiState.video?.title ?: "Video Detail") }, // Replace "Video Detail" with stringResource if using them
                // navigationIcon = { // Optional: Add back button
                //     IconButton(onClick = { navController.popBackStack() }) {
                //         Icon(imageVector = Icons.AutoMirrored.Filled.ArrowBack, contentDescription = "Back") // Replace "Back" with stringResource
                //     }
                // }
            )
        }
